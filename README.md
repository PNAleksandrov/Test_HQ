...
(http://127.0.0.1:8000/training/lessons/<int:product_id>)
...
1. (http://127.0.0.1:8000/training/lessons/)
2. (http://127.0.0.1:8000/training/lessons/<int:product_id>)
3. Реализовать не успел.
